        ...
        <div class="board-view-card">
            ...
            <div class="view-header">
                <div class="view-title-wrap">
                    <span class="badge-region">${dto.getRegion()}</span>
                    <h1 class="view-title">
                        ${dto.getTitle()}
                ...
                <c:if test="${not empty dto.getTags()}">
				    <div class="info-cell full-width">
				        ...
				        <div class="view-tag-list">
				            <c:forTokens items="${dto.tags}" delims="," var="tag">
			        ...
			        <div class="attach-gallery">
			            ...
			            <c:forTokens items="${dto.attach}" delims="," var="file">
			                <div class="gallery-item">
			                    <a href="${pageContext.request.contextPath}/upload/recommend/${file.trim()}" target="_blank">
			                        <img src="${pageContext.request.contextPath}/upload/recommend/${file.trim()}" alt="장소 사진">
			                    </a>
			                </div>
			            </c:forTokens>
			        </div>
            ...
            <div class="btn-group-view">
                ...
                <div class="btn-right">
                    <c:if test="${sessionScope.sessionId eq dto.getReg_id() or sessionScope.sessionLevel eq 'top'}">
                        <a href="javascript:goRec('updateForm')" class="btn-edit">수정</a>
                        <a href="javascript:goRecDelete('${dto.getNo()}')" class="btn-delete">삭제</a>
                    </c:if>
                </div>
            </div>
